      ...
      >
        <List>
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.definitions_units}
          />
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.products_definition}
          />
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.products_category}
          />
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.warehouse_definition}
          />
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.customer_definition}
          />
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.employee_definition}
          />
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.cashBox_definition}
          />
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.banks_definition}
          />
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.consumption_definition}
          />
          <LinkLayout
          ...
          <LinkLayout
            ...
            open={true}
            t={t}
            text={t?.layout?.partners_definition}
          />
        </List>
      </Collapse>
      <ListItemComponent
