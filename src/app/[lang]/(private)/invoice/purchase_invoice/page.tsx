...
import CreatePurchaseInvoicePage from "./_components/createPurchaseInvice";
import InvoiceContextProvider from "../_components/invoiceContext";
import { getDictionary } from "@/dictionaries";

 const PurchaseInvoicePage = async ({params}:{ params: Promise<{ lang: 'en' | 'fa' }>}) => {
