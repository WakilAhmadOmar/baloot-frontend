...
import { useAddPreSellsBillMutation } from "@/hooks/api/invoice/mutations/use-add-pre-sells-bill";
...
const CreateSalesInvoice = () => {
  ...
  const { mutate: addPreSellsBillMutation, isLoading } = useAddPreSellsBillMutation();
  ...
  const onSubmitFunction = async (data: CreateFormSchema) => {
    ...
    addPreSellsBillMutation(variables, {
      onSuccess: () => {
        setHandleError({
